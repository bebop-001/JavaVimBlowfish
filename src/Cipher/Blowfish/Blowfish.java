...
public class Blowfish {
    ...
    {
        // get the number of estimated bytes in the string (cut off
        // broken blocks)
        ...
        // ( try to get all information if the padding doesn't seem to
        // be correct)
    ...
    private static class BlowfishCBC extends BlowfishECB {
        ...
        /**
         * decrypts a long buffer to another long buffer (of
    ...
    /**
     * converts a binhex string back into a byte array (invalid codes
     * will be skipped)
     * @param sBinHex binhex string
     * @param data the target array
     * @param nSrcPos from which character in the string the conversion
     *                should begin,
